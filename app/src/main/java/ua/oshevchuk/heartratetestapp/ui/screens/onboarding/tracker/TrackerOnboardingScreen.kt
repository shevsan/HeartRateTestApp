package ua.oshevchuk.heartratetestapp.ui.screens.onboarding.tracker
...
fun TrackerOnboardingScreen(modifier: Modifier = Modifier, onNextClicked: () -> Unit) {
    TrackerOnboardingScreenContent(modifier = modifier, onNextClicked = onNextClicked)
}
...
@Composable
private fun TrackerOnboardingScreenContentPreview() {
    TrackerOnboardingScreenContent(modifier = Modifier.fillMaxSize(), onNextClicked = {})
}